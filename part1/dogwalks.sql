...
((SELECT dog_id FROM Dogs INNER JOIN Users Dogs.owner_id ON Users.user_id WHERE name = 'Max' AND Users.username = 'alice123'), '2025-06-11 09:00:00', 60, 'City Centre', 'pending'),
