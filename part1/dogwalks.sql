...
((SELECT dog_id FROM Dogs INNER JOIN Dogs.owner_id ON Users.user_id WHERE name = 'Poppy' AND Users.username = 'carol123'), '2025-07-10 09:00:00', 60, 'City Centre', 'pending'),
