...
((SELECT Dogs.dog_id FROM Dogs INNER JOIN Users ON Dogs.owner_id = Users.user_id WHERE name = 'Bella' AND Users.username = 'carol123'), '2025-06-10 09:30:00', 45, 'Beachside Ave', 'accepted'),
((SELECT Dogs.dog_id FROM Dogs INNER JOIN Users ON Dogs.owner_id = Users.user_id WHERE name = 'Max' AND Users.username = 'alice123'), '2025-06-11 09:00:00', 60, 'City Centre', 'pending'),
